...
// Source: internal/core/ports/permissionRepository.go
...
func (m *MockPermissionRepository) Update(ctx context.Context, id, in string) error {
	m.ctrl.T.Helper()
...
func (mr *MockPermissionRepositoryMockRecorder) Update(ctx, id, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockPermissionRepository)(nil).Update), ctx, id, in)
}
